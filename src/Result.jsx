...
function Result({ correctAnswers }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center md:px-24 py-8 rounded-xl shadow-xl gap-6 font-semibold bg-gradient-to-tr from-zinc-200 to-gray-100">
      ...
      <h3 className="text-3xl text-center leading-[3rem] p-6">
        Your Results
      </h3>
      <span className={` text-4xl ${percentage < 40 ? "text-red-600 border-red-600" : "text-green-900 border-green-600"} border-[5px] rounded-full  p-14`} >{percentage}%</span>
      ...
      {percentage > 40 ? (
        ...
        <p className="text-blue-600 text-lg font-medium text-center capitalize">
